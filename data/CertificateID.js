...
export function AddDataForm() {
  ...
  const handleSubmit = () => {
    ...
    const newDataRef = ref(database, `Forms/Form4/Requester: ${user.displayName}`);
    const newData = {
      Name: user.email,
      Access: false,
      DateRequested: new Date().toLocaleDateString(),
      Request: 'Certificate of Non-Issuance of ID',
      form: downloadURL,
    };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.hero}>
        <Image
          source={{
            uri:
              'https://images.pexels.com/photos/8815843/pexels-photo-8815843.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
          }}
      ...
      <View style={styles.content}>
        <View style={styles.contentHeader}>
          <Text style={styles.title}>Certificate of Non-Issuance of ID</Text>
        </View>
