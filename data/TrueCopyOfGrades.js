...
export function AddDataForm() {
  ...
  const handleSubmit = () => {
    ...
    const newDataRef = ref(database, `Forms/Form3/Requester: ${user.displayName}`);
    const newData = {
      Name: user.email,
      Access: false,
      DateRequested: new Date().toLocaleDateString(),
      Request: 'True Copy of Grades',
      form: downloadURL,
    };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.hero}>
        <Image
          source={{
            uri:
              'https://images.pexels.com/photos/175045/pexels-photo-175045.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
          }}
