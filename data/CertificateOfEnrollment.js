...
export function AddDataForm() {
  ...
  const handleSubmit = () => {
    ...
    const newDataRef = ref(database, `Forms/Form1/Requester: ${user.displayName}`);
    const newData = {
      Name: user.email,
      Access: false,
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.hero}>
        <Image
          source={{
            uri:
              'https://images.pexels.com/photos/48148/document-agreement-documents-sign-48148.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
          }}
